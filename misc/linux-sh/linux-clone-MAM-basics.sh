# This script may seem sort of weird in a "chicken or egg" way,
# but it is intended for things like:
#
#    setting up a new "GitRepos" hierarchy when you already have one
