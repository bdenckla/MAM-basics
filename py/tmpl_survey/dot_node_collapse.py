...
def apply_collapse_node_groups(edges, collapse_node_groups):
...
def collapse_equivalent_nodes(edges, column_letters):
...
def collapse_edges_for_output(edges, column_letters, collapse_node_groups=None):
    ...
    collapsed_edges, groups = collapse_equivalent_nodes(remapped_edges, column_letters)
