...
[
  "וַיֹּ֥אמֶר קַ֖יִן אֶל־יְהֹוָ֑ה גָּד֥וֹל עֲוֺנִ֖י ",
  {
    ...
    "tmpl_params": {
      ...
      "2": [
        "=א(ס,ק,ר),ל,ל1,ק3,ו,ל9 (כתיב חסר וי\\\"ו) וכך בספרי תימן <א(ס)=מלא ויו? אינו כן אלא חסר>",
        {
          "tmpl_name": "ש"
        },
        "רמ\\\"ה,ה,ש2=מִנְּשֽׂוֹא (כתיב מלא וי\\\"ו) וכך הוא בספרי ספרד ואשכנז"
      ]
    }
  },
  {
...
_JSON_HAARAH_2_IN_CONTEXT = claim(
