"""Strip a Hebrew word/phrase to its bare letter skeleton (issue UXLC-utils#48).
...
them apart (design doc §7.16; issue UXLC-utils#48 open Q3). Shin/sin dots are stripped like any
other diacritic (issue UXLC-utils#48 general rule), leaving a bare ש.
...
pointed. Built to be reusable by issue UXLC-utils#48's other intended consumer (the reiterated word
