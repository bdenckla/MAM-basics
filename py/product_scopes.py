...
# Two of them live inside a product tree rather than under py/: the vendored example
# scripts the mega runs to prove that a consumer of MAM-parsed and MAM-simple can run
# them from a clone of that product alone.  There were four until 2026-09-12, when Ben
# retired MAM-simple's Sefaria and OSIS examples: "They were mainly relevant when they
# were in standalone repos, and I've abandoned that system of organization."
_GENERATOR_ENTRY_POINTS = (
    ...
    # py/main_mam4sef.py and py/main_mam_osis.py stood here until 2026-09-12, when Ben
    # took their mam4sef-and-ajf and mam-osis steps out of the mega: "I know of no
    # reason to be supplying constantly-updated versions of these."  Both programs and
    # both products remain; they are declared in test_mega_coverage.py's NOT_IN_MEGA
