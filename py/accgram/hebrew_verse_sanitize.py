...
def _sanitize_hebrew_token(
    ...
    *,
    ...
    if keep_all_meteg:
        keep_meteg = has.METEG_ALL
    elif keep_last_meteg:
        keep_meteg = has.METEG_SILLUQ
    else:
        keep_meteg = has.METEG_DROP
    sanitized = has.strip_to_accents(text, keep_meteg=keep_meteg)
