...
class TestDiffMpplusUnpinnedLatest(unittest.TestCase):
    ...
    def test_no_new_commits_writes_empty_unpinned_latest_artifacts(self):
        with (
            ...
            mock.patch.object(diff_mpplus, "_count_newer_commits", return_value=0),
            mock.patch.object(
                diff_mpplus,
                "generate_report",
                return_value=(0, "2026-05-13"),
            ) as generate_mock,
            mock.patch("subcommands.diff_mpplus.os.remove") as remove_mock,
        ):
    ...
    def test_zero_diffs_writes_empty_unpinned_latest_artifacts(self):
        with (
            ...
            mock.patch.object(diff_mpplus, "_count_newer_commits", return_value=2),
            mock.patch.object(
                diff_mpplus,
                "generate_report",
                return_value=(0, "2026-05-13"),
