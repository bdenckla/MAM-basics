...
Usage:
    .venv/Scripts/python.exe py/main_cam1753_find_word_in_images.py <book> <c:v> <hebrew_word>

Example:
    .venv/Scripts/python.exe py/main_cam1753_find_word_in_images.py Job 7:1 "וְכִימֵ֖֗י"
"""
...
def find_and_preview(word, book, cv, *, wide=False):
    ...
    col, line_num, word_idx, line_words, _match_method = _find_word_in_linebreaks(
...
def main():
    ...
    if len(args) != 3:
        print(
            ...
            " py/main_cam1753_find_word_in_images.py [--wide]"
            " <book> <c:v> <hebrew_word>"
        )
