...
from author_boj_util.common_titles_etc import D6_TITLE, D6_H1_CONTENTS, D6_FNAME
...
def _list_item(eqr):
    ...
    link = boj_html.anchor_h(f"Job {cv}", d1d_detail_href(sid))
