...
manuscripts that write the ḥataf vowel explicitly instead of shewa+varika.
"""
...
def _flag_non_inferrable(entries):
    """Flag entries where the inferred ḥataf vowel doesn't match the actual one."""
    n = 0
    ...
    result = {
        "header": {
            "mapping_fields": {
                ...
                "xataf_word": "The word with the explicit ḥataf vowel",
