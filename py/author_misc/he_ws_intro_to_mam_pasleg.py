...
A copy of the Wikisource markup is kept in he_ws_intro_to_mam_pasleg.mediawiki.
...
from author_misc import he_ws_intro_to_mam_pasleg_footnotes as plfn
...
_Y_C31_H = [
    ...
    ",",
    " כגון: לְמִכְנַ֣שׁ ׀ לַֽאֲחַשְׁדַּרְפְּנַיָּ֡א (דניאל ג,ב, וראו הערת לגרמיה בכתי״ל);",
    ' וְשֵׁרֵ֥בְיָ֣ה ׀ יָמִ֡ין (נחמיה ח,ז, וראו הערת לגרמיה בכתי״ל)."',
...
# file:///C:/Users/BenDe/GitRepos/MAM-with-doc/gh-pages/misc/he_ws_intro_to_mam_pasleg.html
