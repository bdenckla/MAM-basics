...
def gen_html_file(tdm_ch):
    cbody = [
        ...
        author.para_for_img("urwotm/Deut 12v30 LAMR -- L color.png", width_em=42.4),
        author.para(_PARA_019),
        author.unordered_list(_LIST_020),
        author.para(_PARA_021),
        author.para_for_img("urwotm/Deut 12v30 LAMR -- BHS.png", width_em=29.6),
        author.para(_PARA_023),
        author.para(_PARA_024),
        author.para_for_img(
            "urwotm/Deut 12v30 LAMR -- L black and white.png", width_em=30.6
        ),
        ...
        author.para_for_img("urwotm/Deut 12v30 LAMR -- BHQ.png", width_em=32.3),
        author.para(_PARA_044),
        author.para(_PARA_045),
        author.para_for_img("urwotm/Deut 12v30 LAMR -- JPS HET.png", width_em=14.2),
        author.para(_PARA_047),
        author.para(_PARA_048),
        author.unordered_list(_LIST_049),
        author.para(_PARA_050),
        author.para_for_img("urwotm/Deut 12v30 LAMR -- Sassoon 507.png", width_em=19.2),
        author.para(_PARA_052),
        author.unordered_list(_LIST_053),
        author.para(_PARA_054),
        author.para(_PARA_055),
        author.para_for_img(
            "urwotm/Deut 12v30 LAMR -- Sassoon 1053.png", width_em=41.6
        ),
        author.para(_PARA_057),
        author.para(_PARA_058),
        author.para(_PARA_059),
        author.para_for_img("urwotm/Deut 12v30 LAMR -- URJ ḥumash.png", width_em=12.2),
