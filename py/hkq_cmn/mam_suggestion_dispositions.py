...
DISPOSITION_BY_REF: dict[str, Disposition] = {
    ...
    "Josh 10:12.3": Disposition(
        ...
        reason=(
            ...
            "purpose a furtive pataḥ counts as a syllable, so the "
            "stress on the שֻׁ (shu) is not final and the repetition is called "
            ...
            "would have it — and here the ש (shin) stands immediately before "
