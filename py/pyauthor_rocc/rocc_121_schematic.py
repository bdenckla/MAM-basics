...
VERSES = [
    ...
    [_bg("כִּ֤י ׀"), _fg(" יוֹמָ֣ם וָלַיְלָה֮ תִּכְבַּ֥ד "), _bg("עָלַ֗י יָ֫דֶ֥ךָ נֶהְפַּ֥ךְ לְשַׁדִּ֑י בְּחַרְבֹ֖נֵי קַ֣יִץ סֶֽלָה׃")],
    [
    ...
    [
        _bg("עַל־זֹ֡את יִתְפַּלֵּ֬ל כׇּל־חָסִ֨יד ׀ אֵלֶיךָ֮ לְעֵ֢ת מְ֫צֹ֥א רַ֗ק לְ֭שֵׁטֶף"),
        _fg(" מַ֣יִם "),
        _bg("רַבִּ֑ים אֵ֝לָ֗יו לֹ֣א יַגִּֽיעוּ׃"),
    ],
    [_bg("אַתָּ֤ה ׀ סֵ֥תֶר לִי֮ מִצַּ֢ר תִּ֫צְּרֵ֥נִי רׇנֵּ֥י פַלֵּ֑ט תְּס֖וֹבְﬞבֵ֣נִי סֶֽלָה׃")],
    [_bg("אַשְׂכִּֽילְךָ֨ ׀ וְֽאוֹרְךָ֗ בְּדֶֽרֶךְ־ז֥וּ תֵלֵ֑ךְ אִיעֲצָ֖ה עָלֶ֣יךָ עֵינִֽי׃")],
    [
        _AL_THYV,
    ...
    [_bg("רַבִּ֥ים מַכְאוֹבִ֗ים"), _fg(" לָ֫רָשָׁ֥ע "), _bg("וְהַבּוֹטֵ֥חַ בַּֽיהֹוָ֑ה חֶ֝֗סֶד יְסוֹבְﬞבֶֽנּוּ׃")],
    [_fg("שִׂמְח֬וּ "), _bg("בַיהֹוָ֣ה וְ֭גִילוּ צַדִּיקִ֑ים וְ֝הַרְנִ֗ינוּ כׇּל־יִשְׁרֵי־לֵֽב׃")],
]
