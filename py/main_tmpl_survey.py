...
def _write_outputs(result, raw_stack_counts, stem, deeply_discard=False):
    ...
    survey_dot.write_focused_dot_files(raw_stack_counts, stem, deeply_discard)
...
def almost_main():
    ...
    _write_outputs(plus_result, plus_raw_sc, f"{_OUT_DIR}/plus", deeply_discard=True)
