...
Usage (run from repo root):
    ...
    .venv/Scripts/python.exe py/main_download.py fr-wikisource --book39 1Samuel
    .venv/Scripts/python.exe py/main_download.py fr-wikisource --section6 SifEm
    .venv/Scripts/python.exe py/main_download.py fr-wikisource --book39 Joshua --chapter 11
    .venv/Scripts/python.exe py/main_download.py fr-wikisource --book-chapters-json path.json
"""
...
def run_from_args(args):
    run(wsds.selected_book_plans(args))
