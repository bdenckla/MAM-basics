...
"""Roundtrip verification of MAM-parsed-plus diff descriptions.
...
def verify_diff(diff):
    ...
    if old_sig != new_sig:
        if not structural_ops:
            ...
            # added a separate path: mpplus_json._serialize_diff computes
            ...
            # Delta is non-empty — mpplus_json will surface it.  No further
