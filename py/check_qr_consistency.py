...
"""
Check that author_boj_qr/qr_*.py filenames, RECORD_* variable names,
...
def main():
    if len(sys.argv) > 1:
        ...
        # The quirk-record package, not the working directory: the records are source.
        paths = [boj_paths.qr_package_dir()]
