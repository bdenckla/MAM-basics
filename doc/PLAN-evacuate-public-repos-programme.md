...
State: the Python-only programme executed 2026-08-22; the second stage's Phase 5 has completed
Steps 1–3; a third stage was decided 2026-09-02 and is not started
...
| **Second stage — the total evacuation of book-of-job, holman-ketiv-qere and UXLC-utils** | [PLAN-evacuate-the-rest-of-three-repos.md](PLAN-evacuate-the-rest-of-three-repos.md) | **IN PROGRESS 2026-09-03.** Phase 0, the `.gitattributes` verification, redirect-generator generalization, and the holman-ketiv-qere and book-of-job lanes are complete. UXLC-utils Steps 1–3 landed the pure-prefix trees, scoped their licences, and repointed every MAM-basics reader; its 27 modified source artifact paths leave source stubs, source emptying and clone removal unstarted. The temporary codex-index-leningrad sparse vendor is retained and reads MAM-basics under Ben's 2026-09-03 authorization. Decision G's third stage and both stages' bookkeeping remain unstarted. |
