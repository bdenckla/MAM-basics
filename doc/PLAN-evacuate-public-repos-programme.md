...
third stage completed 2026-09-04; Phase 0 of the fourth stage completed 2026-09-05
...
| **Fourth stage — the five MAM products, total evacuation** | [PLAN-evacuate-five-MAM-products.md](PLAN-evacuate-five-MAM-products.md) | **Phase 1 DONE 2026-09-06.** MAM-simple landed in MAM-basics at `cf7c7a35`; source commit `9a350be` retained a verified Pages redirect host, and the clean source clone moved to the Windows Recycle Bin. MAM-simple's corpus, example, vendoring, and Cambridge 1753 line-break oracles passed; the post-removal MAM-basics suite passed 973 tests, skipped 5 tests, and passed 65 subtests. The remaining lane order is MAM-for-Sefaria, MAM-parsed, MAM-with-doc, then MAM-OSIS. MAM-private's separate census program remains out of scope. |
...
## Fourth stage — the five MAM products, total evacuation — **PURSUED 2026-09-04; Phase 1 done 2026-09-06**
