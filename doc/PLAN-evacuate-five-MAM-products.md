...
Note recorded by a Claude session on 2026-09-11, for finding 6 of the 2026-09-10 review: the
unchanged generated bytes that the Phase 6 records verify are the state at `40b8ea4b`
...
`doc/PLAN-efficient-wikisource-downloads.md`) reached `main` after `40b8ea4b`, through the merge
`a0a2e3ab` at 21:22, and changed outputs Phase 6 had verified. Measured by that review at
`0354b6cc`: 97 of the 415 outputs 6B records, 16 of 6C's 99 and 57 of 6D's 295 no longer carry
their recorded Git blobs, each last changed by `209b4c05`, `321b2eeb`, `426fa229`, `8f5c1c96`
or `516a4a1a`, and none of those five commits is an ancestor of `40b8ea4b`
(`git merge-base --is-ancestor <commit> 40b8ea4b`). The records are dated and name `40b8ea4b`,
so they are right as written; this note says only that their "unchanged" describes that commit
and not a later tree. Neither this plan nor the programme mentioned the cutover before this note.
