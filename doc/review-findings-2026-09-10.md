...
7. **`.novc` pointers in tracked prose, unfixed under Ben's rule of 2026-09-10: 208 lines in 17
   documents the window added, and the rule has no tracked home.** Ben's word, quoted in
