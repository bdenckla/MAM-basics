...
Recorded by Codex on 2026-09-12. The plan's line beginning `State: complete` uses a word outside
the five-word plan-State vocabulary declared in `py/repo_util/check_repo_standards.py`. The plan
is a finished execution record and remains unchanged. Its State declaration in the conventional
form is `State: executed 2026-09-10`, the date on which Phase 6 and the five-product evacuation
programme completed.
