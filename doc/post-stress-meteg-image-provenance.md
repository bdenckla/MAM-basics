...
| Filename under `gh-pages/img/` | Codex | Verse | Folio, column, and line recorded in the caption | Photograph source | Rights holder |
|---|---|---|---|---|---|
...
Rights-holder identification remains deferred, as does photograph-source identification for the
six older crops where the public record does not name it. The inventory adds no source attribution
from neighbouring material and no interpretation of an image. The existing license terms remain
**each rights holder's; no grant is made or implied here.**
