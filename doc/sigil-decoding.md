...
| ק13 | Cairo 13 (Writings), Eastern script, written 1028 by Zechariah ben Anan; complete | Conflicting | Wikisource | The appendix's entry is `כתי"ק13 (כתובים, כתיבה מזרחית מאת זכריה בן ענן, שנת ד' תשפ"ח [1028]); שלם`, and its entry for St Petersburg EVR-II-B-8 calls Zechariah ben Anan "the scribe of כת"י קהיר 13 for the Writings" — so ק13 is a Cairo manuscript, numbered like ק2 (Cairo 27), ק3 (Cairo 18) and ק25 (Cairo 25). Until 2026-08-23 this row said "Ms Cambridge T-S 13", which is also what `py/accgram/ps17v14_mam_doc_notes_body.py` glosses it as on its rendered page; that gloss has no source behind it in the appendix, and under this document's weighting Wikisource wins. The Ps 17:14 page still carries the old gloss and wants fixing. |
