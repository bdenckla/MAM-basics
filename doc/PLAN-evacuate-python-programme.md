...
**Both halves of that instruction have now been satisfied, 2026-08-22.** The trio's Python
evacuation finished that morning, and the new plan was written the same day:
[`PLAN-evacuate-the-rest-of-three-repos.md`](PLAN-evacuate-the-rest-of-three-repos.md). It is
unexecuted — Phase 0 not started — and it opens with five decisions that need Ben's answers before
its Phase 1. **Ben added a sixth requirement while it was being written**, which the programme's
decision above does not cover and which this paragraph is the record of: **each evacuated repo's
...
## Third stage — the codex-index trio and diffable-pointed-hebrew, total evacuation — **DECIDED 2026-09-02, NOT STARTED**

**Not to be started until Ben says so — he asked on 2026-09-02 for the plan to be recorded, not
run, and not run in a fresh session either.** This section is the decision record and the
outline a plan file is written from. That file,
`C:\Users\BenDe\GitRepos\MAM-basics\doc\PLAN-evacuate-the-codex-index-trio-and-diffable-pointed-hebrew.md`,
does not exist yet; when the stage begins it is written in the relationship
`PLAN-evacuate-the-rest-of-three-repos.md` has to `PLAN-evacuate-the-rest-of-wlc-utils.md` —
cite the second stage's six-step lane (Land, Licence, Repoint, Stubs, Empty, Remove) and its four
oracle layers by section name, and state only what differs. Call this **the third stage**; the
second stage is `PLAN-evacuate-the-rest-of-three-repos.md`, and the first was this programme.
...
**What is NOT expected to change while this stage is unstarted**: any file outside `doc/` in
MAM-basics, any of the seven candidate repos, any forest. A diff elsewhere is a finding.
