...
| UXLC-utils | [PLAN-evacuate-python-from-UXLC-utils.md](PLAN-evacuate-python-from-UXLC-utils.md) | **Phases 1, 3, 4 and 5 done**, plus Phase 7 item 1 (Phase 1 2026-08-02: `fe73d07` there, `d5a5052` here; Phase 3 2026-08-02: `662db55` and `f202d21` here, nothing there; Phase 4 2026-08-03: `ad52001` there, `2b5c87c` here; Phase 5 2026-08-03: `d5195e3` in codex-index-leningrad, `748ee2f` there, nothing in this repo's `py/`). **UXLC-utils now holds zero Python** and its 214 artifacts still regenerate byte-identically from here. **Phase 5 dropped codex-index-leningrad's sparse `py/` half rather than repointing it** — the shared decision with the codex-index trio, now written into that plan too. **Phases 6 and 7 remain** — Phase 6 whole (Phase 1 measured it at two strings in two files), and Phase 7's items 2–5. **Item 6 — the hebrew-prose skill's citations of UXLC-utils Python — is DONE, 2026-08-17, github-misc `549224e`**, Ben having approved it alongside the rest-of-wlc-utils plan's Phase 11 edits to that same unsynced pair; it came to one line, and that plan's record has the shape of the pair's verification. This row said "Only Phase 6 remains" until the 2026-08-03 review ([#219](https://github.com/bdenckla/MAM-basics/issues/219), major 4) caught the overstatement; corrected 2026-08-04 |
