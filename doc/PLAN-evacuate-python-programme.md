...
5. **codex-index trio** — last, and as one plan, because the three share a shape, share the
   ...
   **What step 5 hands the rest of this programme, and it is one thing:** the phase found two
   ...
   oracle at all.
   **Phase 1 is DONE too, 2026-08-22** -- `ee09e67`, `eb7c83c` and `7e5ca23`, one per repo, and
   nothing owed in MAM-basics beyond its record. It did the repoint first as instructed, and
