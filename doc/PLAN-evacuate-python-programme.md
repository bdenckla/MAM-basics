...
4. **book-of-job** — the largest, and the one whose Python is not under a `py/` at all. **Phases 0,
   ...
   **delete** the 40 orphaned UXLC data files. **Phase 6 is DONE as well, 2026-08-22** — one commit
   ...
   keeping 61 issues numbered 1–61. **Only Phase 7 items 2–6 remain of this step**, item 1 having
   fired inside Phase 4; item 5's target is a **153 MB** venv that no tracked file names, so it
   needs no documentation edit first. All five
