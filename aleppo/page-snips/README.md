...
Crops of Aleppo Codex page images, kept as the evidence behind a stated fact about the
manuscript. One file per fact, named `<leaf>-<ref>-<slug>.png`, the leaf in this tree's
`{leaf_number}{r|v}` form (`../README.md`); a column and line go into the name as
`<leaf>-col<N>-line<N>-<ref>-<slug>.png` when they have been established, as they have for the
Job leaves through `../line-breaks/`.
...
(`../../leningrad/page-snips/380A-col2-line3-Ps72v15-yevarkhenhu.png`). With the stress
...
manuscript agrees. The whole account is `../../doc/meteg-after-silluq-psalms-72-15.md`.

## 271r-col2-line5-Job4v12-menhu.png

Job 4:12, the verse-final word, which ends **line 5 of column 2 of leaf 271r**
(`../line-breaks/271r.json` lines 814–836). Ben's crop, 2026-09-10. Which site it was read from
is not yet recorded.
...
leaf, `../aleppo-pages/271r.jpg`, has the same two strokes at its resolution.

The stroke under the mem stands to the right of its segol, in the same place as the Leningrad
Codex's (`../../leningrad/page-snips/398A-col2-line4-Job4v12-menhu.png`). Ben calls it an early
...
account is `../../doc/meteg-after-silluq-job-4-12.md`.
